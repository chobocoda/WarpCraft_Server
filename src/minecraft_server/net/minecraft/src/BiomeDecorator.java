...
public class BiomeDecorator
{
    ...
    protected int bigmushroomPerChunk;
    ...
    protected void decorate_do()
    {
        ...
        for(int i2 = 0; i2 < bigmushroomPerChunk; i2++)
        {
            int k6 = chunk_X + decoRNG.nextInt(16) + 8;
            int l10 = chunk_Z + decoRNG.nextInt(16) + 8;
            bigMushroomGen.generate(currentWorld, decoRNG, k6, currentWorld.getHeightValue(k6, l10), l10);
        }
