...
public abstract class GenLayer
{
    ...
    public static GenLayer[] func_35497_a(long l)
    {
        ...
        obj = new GenLayerZoomFuzzy(2001L, ((GenLayer) (obj)));
        obj = new GenLayerIsland(2L, ((GenLayer) (obj)));
        obj = new GenLayerSnow(2L, ((GenLayer) (obj)));
        obj = new GenLayerZoomFuzzy(2002L, ((GenLayer) (obj)));
        obj = new GenLayerIsland(3L, ((GenLayer) (obj)));
        obj = new GenLayerZoomFuzzy(2003L, ((GenLayer) (obj)));
        obj = new GenLayerIsland(4L, ((GenLayer) (obj)));
        obj = new GenLayerIsland(5L, ((GenLayer) (obj)));
        byte byte0 = 4;
        GenLayer obj1 = obj;
        ...
        for(int i = 0; i < byte0; i++)
        {
            ...
            //obj3 = new GenLayerTemperatureMix(((GenLayer) (obj3)), ((GenLayer) (obj2)), i); // CHOBO: Removed because these are fucking atrocious
            obj4 = new GenLayerSmoothZoom(1000 + i, ((GenLayer) (obj4)));
            //obj4 = new GenLayerDownfallMix(((GenLayer) (obj4)), ((GenLayer) (obj2)), i); // CHOBO: Removed because these are fucking atrocious
        }
